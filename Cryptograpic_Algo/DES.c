...
int main()
{
    ...
    printf("\nThe input plaintext (max 64-bit) is : ");
    char c = fgetc(inp);
    while (c != EOF)
    {
        printf ("%c", c);
    ...
    out = fopen("decrypted.txt", "r");
    printf("\nThe decrypted text in bits: ");
    c = fgetc(out);
    while (c != EOF)
    {
        printf ("%c", c);
...
The input plaintext (max 64-bit) is : akashhhh
The ciphertext in bits : 1111010010001111010010011100111000010001011011101110000010100100
The decrypted text in bits: 0110000101101011011000010111001101101000011010000110100001101000
The final decrypted text is : akashhhh
--------------------------------
